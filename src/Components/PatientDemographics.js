...
const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/patients/?email_address=${email}`, {
  method: "GET",
  headers: {
...
const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/patients/`, {
  method: "POST",
  headers: {
